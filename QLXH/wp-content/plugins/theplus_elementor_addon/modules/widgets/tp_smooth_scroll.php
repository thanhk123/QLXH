...
class ThePlus_Smooth_Scroll extends Widget_Base {
    ...
    protected function register_controls() {
	 ...
	 protected function render() {
		...
		$Browsers = !empty($settings['browsers']) ? $settings['browsers'] : [];
