<?php
    ...
    namespace Actions_Pack\acf;

    class Image extends \acf_field {
        ...
        */
        ...
        function initialize() {
            ...
            // vars
            $this->name     = 'image_actions_pack';
            $this->label    = __( 'Image (Actions Pack)', 'acf' );
        ...
        */
        ...
        function input_admin_enqueue_scripts() {
            ...
            wp_register_script('ap-acf-image', AP_PLUGIN_DIR_URL."assets/js/ap-acf-image.js");
            wp_enqueue_script('ap-acf-image');
        ...
        function render_field( $field ) {
            ...
            if ( $field['value'] ) {
                ...
                elseif( filter_var($field['value'], FILTER_VALIDATE_URL) ){
                    $image = array($field['value']);
                }else{
                    $image = array();
                }
