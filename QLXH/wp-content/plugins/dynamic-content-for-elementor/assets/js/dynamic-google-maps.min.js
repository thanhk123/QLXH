...
if(google!==undefined){initMap()}else{window.addEventListener('dce-google-maps-api-loaded',initMap)}};$(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/dyncontel-acf-google-maps.default',DyncontEl_GoogleMapsHandler);elementorFrontend.hooks.addAction('frontend/element_ready/dce-metabox-google-maps.default',DyncontEl_GoogleMapsHandler)})})(jQuery);(function($){"use strict";$(function(){$(document).on("sf:ajaxfinish",".searchandfilter",function(e,data){if(elementorFrontend){if(elementorFrontend.elementsHandler.runReadyTrigger&&SF_LDATA.extensions.indexOf('search-filter-elementor')<0){elementorFrontend.elementsHandler.runReadyTrigger(data.targetSelector)}}})})}(jQuery))