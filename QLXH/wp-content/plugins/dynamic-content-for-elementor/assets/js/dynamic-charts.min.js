...
options={responsive:!0,maintainAspectRatio:!1,};if(elementSettings.show_legend){options.plugins={legend:{display:elementSettings.show_legend||!0,labels:{color:elementSettings.legend_color||Chart.defaults.color,},position:elementSettings.legend_position||'top',align:elementSettings.legend_align||'center',},}}
scales={scales:{y:{beginAtZero:Boolean(elementSettings.begin_at_zero),grace:elementSettings.grace||0,ticks:{color:elementSettings.axis_y_labels_color||Chart.defaults.color,},grid:{color:elementSettings.axis_y_grid_color||Chart.defaults.color,}},x:{ticks:{color:elementSettings.axis_x_labels_color||Chart.defaults.color,},grid:{color:elementSettings.axis_x_grid_color||Chart.defaults.color,}},},};if('line'===elementSettings.type||'bar'===elementSettings.type){$.extend(options,scales)}
